...
const TRANSLATIONS = {
  es: {
    hero_sub_top: "Las recetas de mi abuela",
    ...
    filter_rating_label: "Filtrar por valoración",
    ...
    likes_label: "likes",
    based_on_reactions: (n) => `Basado en ${n} ${n === 1 ? 'reacciÃ³n' : 'reacciones'}`,
    reaction_prompt: "Â¿Te apetece esta receta?",
  ...
  en: {
    ...
    filter_special: "Tags",
    filter_rating_label: "Filter by rating",
    ...
    likes_label: "likes",
    based_on_reactions: (n) => `Based on ${n} ${n === 1 ? 'reaction' : 'reactions'}`,
    reaction_prompt: "Would you try this recipe?",
    reaction_thanks: "Thanks for reacting!",
